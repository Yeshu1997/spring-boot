...
public class MovieServiceDummyImpl {



    @Service("movieServiceDummy")
    @Profile("dev")
    public class MovieServiceDummyImp implements MovieService {

        private MovieRepository movieRepository;


        @Autowired
        public MovieServiceDummyImp(MovieRepository movieRepository) {
